...
"[project]/code/hp2/packages/web/app/actions/invitations.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40360a602e9cbeb768c4e21134ec04e7bd6d25610f":"getMyInvitations","40405171cd44e9f051f66702dc3e6b01cb3a110ada":"getTeamInvitations","409334ad248d109df2011949e159934d0cc4f46e87":"getInvitationByToken","40a01c657fbfb8ef04c331c180929a648ab48b6208":"revokeTeamInvitation","60fa6cffb379eaa7639a0e853e945b9628a52824e1":"acceptTeamInvitation","7c6340e5d098db8a416d216020a97ed16423fba857":"createTeamInvitation"},"",""] */ __turbopack_context__.s([
...
;
;
async function createTeamInvitation(teamId, email, role, invitedBy, sendEmail = true) {
    try {
        ...
        const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('user_profiles').select('email_verified').eq('id', invitedBy).single();
        if (profileError || !profile) {
            return {
                success: false,
                error: 'User profile not found'
        ...
        const { data: existingProfile } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('user_profiles').select('id').eq('email', email).maybeSingle();
        if (existingProfile) {
            const { data: existingMember } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_members').select('id').eq('team_id', teamId).eq('user_id', existingProfile.id).maybeSingle();
            if (existingMember) {
                return {
                    success: false,
                    error: 'User is already a member of this team'
        ...
        const { data: pendingInvite } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_invitations').select('id').eq('team_id', teamId).eq('email', email).eq('status', 'pending').maybeSingle();
        if (pendingInvite) {
            return {
                success: false,
        ...
        const token = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomBytes(32).toString('hex');
        // 5. Create invitation
        const { data: invitation, error: inviteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_invitations').insert({
            team_id: teamId,
            email: email.toLowerCase(),
            role,
            token,
        ...
        if (sendEmail) {
            ...
            const { data: team } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('teams').select('name').eq('id', teamId).single();
            const { data: inviter } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('user_profiles').select('full_name, email').eq('id', invitedBy).single();
            if (team && inviter) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$email$2f$resend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendTeamInvitationEmail"])(email, {
...
async function getMyInvitations(email) {
    try {
        const { data: invitations, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_invitations').select('id, team_id, token, email, role, status, created_at, expires_at, invited_by').eq('email', email.toLowerCase()).eq('status', 'pending').order('created_at', {
            ascending: false
        });
        if (error) {
        ...
        const { data: teams } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('teams').select('id, name').in('id', teamIds);
        // Get inviter names
        const inviterIds = invitations.map((inv)=>inv.invited_by);
        const { data: inviters } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('user_profiles').select('id, full_name, email').in('id', inviterIds);
...
async function getTeamInvitations(teamId) {
    try {
        const { data: invitations, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_invitations').select('id, email, role, status, created_at, expires_at, invited_by').eq('team_id', teamId).order('created_at', {
            ascending: false
        });
        if (error) {
...
async function revokeTeamInvitation(invitationId) {
    try {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_invitations').update({
            status: 'revoked'
        }).eq('id', invitationId);
        if (error) {
...
async function getInvitationByToken(token) {
    try {
        const { data: invitation, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_invitations').select('id, team_id, email, role, status, expires_at, invited_by').eq('token', token).maybeSingle();
        if (error) {
        ...
        const { data: team } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('teams').select('name').eq('id', invitation.team_id).single();
        const { data: inviter } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('user_profiles').select('full_name, email').eq('id', invitation.invited_by).maybeSingle();
        return {
            success: true,
            invitation: {
                id: invitation.id,
...
async function acceptTeamInvitation(token, userId) {
    try {
        ...
        // 2. Get user email
        const { data: userProfile } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('user_profiles').select('email').eq('id', userId).single();
        if (!userProfile) {
            return {
                success: false,
                error: 'User profile not found'
        ...
        const { data: existingMember } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_members').select('id').eq('team_id', invitation.team_id).eq('user_id', userId).maybeSingle();
        if (existingMember) {
            // Mark as accepted anyway
            await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_invitations').update({
                status: 'accepted',
        ...
        // 5. Add user to team
        const { error: memberError } = await __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$lib$2f$db$2f$supabase$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('team_members').insert({
            team_id: invitation.team_id,
            user_id: userId,
            role: invitation.role
        });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createTeamInvitation, "7c6340e5d098db8a416d216020a97ed16423fba857", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getMyInvitations, "40360a602e9cbeb768c4e21134ec04e7bd6d25610f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTeamInvitations, "40405171cd44e9f051f66702dc3e6b01cb3a110ada", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(revokeTeamInvitation, "40a01c657fbfb8ef04c331c180929a648ab48b6208", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getInvitationByToken, "409334ad248d109df2011949e159934d0cc4f46e87", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(acceptTeamInvitation, "60fa6cffb379eaa7639a0e853e945b9628a52824e1", null);
}),
"[project]/code/hp2/packages/web/.next-internal/server/app/demo/teams/page/actions.js { ACTIONS_MODULE0 => \"[project]/code/hp2/packages/web/app/actions/teams.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/code/hp2/packages/web/app/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/code/hp2/packages/web/app/actions/invitations.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$invitations$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/hp2/packages/web/app/actions/invitations.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/code/hp2/packages/web/.next-internal/server/app/demo/teams/page/actions.js { ACTIONS_MODULE0 => \"[project]/code/hp2/packages/web/app/actions/teams.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/code/hp2/packages/web/app/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/code/hp2/packages/web/app/actions/invitations.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "40360a602e9cbeb768c4e21134ec04e7bd6d25610f",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$invitations$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getMyInvitations"],
    "405c45025e9a13f66027d9ac2cda37fb543cc9d0bb",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$teams$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTeamStats"],
    "40a01c657fbfb8ef04c331c180929a648ab48b6208",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$invitations$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revokeTeamInvitation"],
    ...
    "60fa6cffb379eaa7639a0e853e945b9628a52824e1",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$invitations$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["acceptTeamInvitation"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f2e$next$2d$internal$2f$server$2f$app$2f$demo$2f$teams$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$teams$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$invitations$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/code/hp2/packages/web/.next-internal/server/app/demo/teams/page/actions.js { ACTIONS_MODULE0 => "[project]/code/hp2/packages/web/app/actions/teams.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/code/hp2/packages/web/app/actions/auth.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/code/hp2/packages/web/app/actions/invitations.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$teams$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/hp2/packages/web/app/actions/teams.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/hp2/packages/web/app/actions/auth.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$actions$2f$invitations$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/hp2/packages/web/app/actions/invitations.ts [app-rsc] (ecmascript)");
}),
...
"[project]/code/hp2/packages/web/app/demo/teams/page.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/code/hp2/packages/web/app/demo/teams/page.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/code/hp2/packages/web/app/demo/teams/page.tsx <module evaluation>", "default");
}),
"[project]/code/hp2/packages/web/app/demo/teams/page.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/code/hp2/packages/web/app/demo/teams/page.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/code/hp2/packages/web/app/demo/teams/page.tsx", "default");
}),
"[project]/code/hp2/packages/web/app/demo/teams/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$demo$2f$teams$2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/code/hp2/packages/web/app/demo/teams/page.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$demo$2f$teams$2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/code/hp2/packages/web/app/demo/teams/page.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$hp2$2f$packages$2f$web$2f$app$2f$demo$2f$teams$2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/code/hp2/packages/web/app/demo/teams/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/code/hp2/packages/web/app/demo/teams/page.tsx [app-rsc] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__746d2a7f._.js.map