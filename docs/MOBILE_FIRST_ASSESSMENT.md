...
| Feature | Mobile Score | Priority | Notes |
|---------|--------------|----------|-------|
| **Home/Landing** | 🟢 8/10 | Low | Already responsive, minor tweaks |
| **Game Tracking** | 🔴 3/10 | **CRITICAL** | Fixed-width ice surface, complex layout |
| **Analytics Dashboard** | 🟡 5/10 | High | Charts don't scale, tables overflow |
| **Practice History** | 🟡 4/10 | High | Table layout breaks, modal too large |
| **Practice Builder** | 🔴 2/10 | **CRITICAL** | Drag-and-drop not mobile-friendly |
| **Drill Library** | 🟡 6/10 | Medium | Search works, but cards could be better |

**Overall Mobile Readiness: 4.7/10** ⚠️ Needs significant work

---

## 🎯 CRITICAL ISSUES (Fix First)

### 1. Game Tracking - Live Event Logger
**Current Issues:**
- ❌ Ice surface is 700x350px fixed width (overflows on mobile)
- ❌ 3-column layout (`lg:grid-cols-3`) stacks awkwardly
- ❌ Event logger flow not optimized for touch
- ❌ Player selector grid too small on mobile
- ❌ Stats panel hidden on small screens

**Impact:** This is THE core feature - coaches track games on-site at rinks
...
- [ ] Make ice surface responsive (use 100% width, maintain aspect ratio)
- [ ] Stack event buttons vertically on mobile with larger touch targets
- [ ] Use bottom sheet for player selection (fixed position overlay)
- [ ] Make stats panel a collapsible accordion (starts collapsed)
- [ ] Optimize event flow: fewer taps, bigger buttons
- [ ] Add swipe gestures for undo/delete events
...
### Week 1: CRITICAL - Game Tracking Mobile
- [ ] Responsive ice surface (SVG scales to screen)
- [ ] Vertical event button layout
- [ ] Bottom sheet player selector
- [ ] Collapsible stats panel
- [ ] Swipe gestures for event list
